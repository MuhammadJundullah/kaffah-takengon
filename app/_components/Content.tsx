      ...
      <div className="min-h-screen sm:p-4 text-black sm:m-10 mx-5">
        ...
        <div className="text-gray-500 dark:text-white sm:leading-10 leading-8 sm:text-medium md:text-medium">
          ...
          <ul>
            ...
            <li>
              - Jika terdapat isi dari kolom bulan 1/4 artinya anda telah
              melunasi 1 edisi kaffah dari 4 jumat dalam bulan tersebut.{" "}
            </li>
            <li>
              - Jika terdapat isi dari kolom bulan 4/4 artinya anda telah
              melunasi seluruh edisi kaffah dari 4 jumat dalam bulan tersebut.{" "}
            </li>
            <li>
          ...
          <form
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (selectedYear) {
                  setKaffahData(
                    originalKaffahData.filter(
                      (data) => data.tahun === selectedYear
                    )
                  );
                } else {
                  setKaffahData(originalKaffahData); // reset ke original
                }
              }}>
